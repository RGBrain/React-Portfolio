        ...
        <section className="home mt-5 pt-5">
          <div className="home text-white ">
            <div className="container border rounded mb-5" id="about">
              ...
              <div className="container-flex d-flex p-4">
                <NavLink to="/projects" className='text-white nav-link active bg-transparent nav-router m-3'><button className="btn btn-lg btn-primary homepage-btn glow-on-hover">Projects</button></NavLink><NavLink to="/contact" className='text-white nav-link active bg-transparent '><button className="btn btn-lg btn-primary homepage-btn m-3 glow-on-hover">Contact</button></NavLink>
              </div>
            </div>
          </div>
        </section>
