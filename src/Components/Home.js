...
import profilePic from '../../public/images/portrait-pic5'
        ...
        <section className="home mt-5 pt-5">
          <div className="home text-white" id="intro">
            <div className="container border rounded mb-5" id="about">
              ...
              <img className="float-end border rounded" id="portrait" src={profilePic} alt="Richard Brain Portrait" height={300}></img>
